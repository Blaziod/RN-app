...
const Advertise1AMMenu = () => {
  ...
  const result =
    userBalance?.balance -
    (isNaN(Number(chooseNumber)) ? 0 : Number(chooseNumber) * 30);
  ...
  const createTask = async (paymentMethod = 'trendit_wallet') => {
    ...
    taskData.append('amount', chooseNumber * 30);
  ...
  return (
    <View>
      ...
      <View
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          This is the number of |Followers you want us to get for you
        </Text>
        <Modal
          transparent={true}
          animationType="fade"
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          The Link to Your Audiomack Account
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
...
export default Advertise1AMMenu;
