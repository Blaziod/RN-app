  ...
  return (
    <View>
      ...
      <View
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          Number of Download and Reviews you want
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          Enter the number of downloads and Review you desired and want us to
          get for you
        </Text>
        <Modal
          transparent={true}
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          The Link to Your Apple Store App
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
...
export default Advertise1APMenu;
