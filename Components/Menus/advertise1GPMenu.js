...
const Advertise1GPMenu = () => {
  ...
  const result =
    userBalance?.balance -
    (isNaN(Number(chooseNumber)) ? 0 : Number(chooseNumber) * 100);
  ...
  const createTask = async (paymentMethod = 'trendit_wallet') => {
    ...
    taskData.append('amount', chooseNumber * 100);
  ...
  return (
    <View>
      ...
      <View
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          Number of Downloads and Reviews you want
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          Enter the number of Downloads and Reviews you want us to get for you
        </Text>
        <Modal
          transparent={true}
          animationType="fade"
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          The Link to Your Google Playstore App
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          Enter the link to the app you want people to download and review.
          ensure the link you paste here is the link to your app
        </Text>
      </View>
      <View
        style={{
...
export default Advertise1GPMenu;
