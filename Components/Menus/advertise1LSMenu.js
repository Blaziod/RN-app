...
const Advertise1LSMenu = () => {
  ...
  const result =
    userBalance?.balance -
    (isNaN(Number(chooseNumber)) ? 0 : Number(chooseNumber) * 3);
  ...
  const createTask = async (paymentMethod = 'trendit_wallet') => {
    ...
    taskData.append('amount', chooseNumber * 3);
  ...
  return (
    <View>
      ...
      <View
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          Enter the number of Likes you want us to get for you
        </Text>
        <Modal
          transparent={true}
          animationType="fade"
        ...
        <Text
          style={{color: '#B1B1B1', fontSize: 10, fontFamily: 'CamptonBook'}}>
          Enter the link to the post you want people to like. ensure the link
          you paste here is the link to your post not your page
        </Text>
      </View>
      <View
        style={{
...
export default Advertise1LSMenu;
