...
const Advertise1SPMenu = () => {
  ...
  const result =
    userBalance?.balance -
    (isNaN(Number(chooseNumber)) ? 0 : Number(chooseNumber) * 10);
  ...
  const createTask = async (paymentMethod = 'trendit_wallet') => {
    ...
    taskData.append('amount', chooseNumber * 10);
  ...
  return (
    <View>
      ...
      <View
        ...
        <Text style={{color: '#fff', fontFamily: 'CamptonBook', fontSize: 13}}>
          The Link to Your Spotify Account
        </Text>
        <TouchableOpacity
          style={{
            backgroundColor: '#2f2f2f6b',
...
export default Advertise1SPMenu;
