...
const Earn1CMMenu = () => {
  ...
  const splitTextIntoLines = (text, maxLength = 50) => {
            ...
            pendingTasks.map((task, index) => (
              <TouchableOpacity
                ...
                <Text
                  ...
                  {tasks.account_link || tasks.caption}
                </Text>
                <View
                  style={{
                    flexDirection: 'row',
                        ...
                        <View
                          ...
                          <View
                            ...
                            <Text
                              ...
                              Engagement task now. You have 1 hour to perform
                              this task. Please confirm only if you are ready to
                              perform the task.
                            </Text>
                          </View>
                          <View
