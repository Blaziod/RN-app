          ...
          {pendingTasks.length > 0 ? (
            pendingTasks.map((task, index) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('Earn2TK')}>
                <View
                  style={{
                    flexDirection: 'row',
                    gap: 10,
                        ...
                        <View
                          ...
                          <View
                            ...
                            <Text
                              ...
                              Generate Next Tiktok Advert Task?
                            </Text>
                            <Text
                              style={{
                                color: '#fff',
                              ...
                              Are you sure you want to generate your next Tiktok
                              Advert task now. You have 1 hour to perform this
                              task. Please confirm only if you are ready to
                              perform the task.
                            </Text>
                          </View>
                          <View
