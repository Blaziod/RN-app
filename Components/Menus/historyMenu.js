...
const HistoryMenu = () => {
  ...
  const userAdverts = async () => {
    ...
    if (userAccessToken) {
      try {
        const response = await fetch(`${ApiLink.ENDPOINT_1}/user/tasks`, {
          method: 'GET',
          headers: {
        ...
        if (response.ok) {
          ...
          setTasks(data.all_tasks); // Set tasks state
  ...
  const platformText = {
    instagram: 'Get People to post your advert on Instagram',
    twitter: 'Get People to post your advert on Twitter',
    tiktok: 'Get People to post your advert on Tiktok',
    threads: 'Get People to post your advert on Threads',
    whatsapp: 'Get People to post your advert on WhatsApp',
    facebook: 'Get people to post your Advert on Facebook',
  };
    ...
    pending: (
      <TouchableOpacity
        style={{
          ...
          alignItems: 'center',
          flexDirection: 'row',
          borderColor: 'rgba(142, 96, 207, 0.23)',
        }}>
        <Svg
          xmlns="http://www.w3.org/2000/svg"
          width="15"
          ...
          fill="none">
          <Path
            d="M10.0014 6.66675V10.0001L11.4447 10.8334M1.88413 11.894C1.74273 11.2856 1.66797 10.6516 1.66797 10.0001C1.66797 9.3486 1.74273 8.71459 1.88413 8.10614M8.48615 1.80415C8.97748 1.7139 9.48388 1.66675 10.0013 1.66675C14.6037 1.66675 18.3346 5.39771 18.3346 10.0001C18.3346 14.6025 14.6037 18.3334 10.0013 18.3334C9.48388 18.3334 8.97748 18.2863 8.48615 18.196M5.83464 2.7816C4.69799 3.43911 3.73106 4.35739 3.01564 5.45463M3.01564 14.5455C3.73106 15.6428 4.69799 16.561 5.83464 17.2186"
            stroke="black"
    ...
    complete: (
      <TouchableOpacity
        ...
        <Svg
          ...
          fill="none">
          <Path
            d="M1.81928 8.32584C1.7203 7.89993 1.66797 7.45612 1.66797 7.00008C1.66797 6.54405 1.7203 6.10024 1.81928 5.67432M6.4407 1.26293C6.78463 1.19976 7.13911 1.16675 7.5013 1.16675C10.723 1.16675 13.3346 3.77842 13.3346 7.00008C13.3346 10.2217 10.723 12.8334 7.5013 12.8334C7.13911 12.8334 6.78463 12.8004 6.4407 12.7372M4.58464 1.94714C3.78898 2.4074 3.11213 3.0502 2.61134 3.81826M2.61134 10.1819C3.11213 10.95 3.78898 11.5928 4.58464 12.053M9.2513 5.83341L6.95637 8.12835C6.93473 8.14998 6.90005 8.15122 6.87692 8.13119L5.7513 7.15594"
            stroke="white"
            stroke-linecap="round"
          />
        </Svg>
            ...
            <View style={[styles.box]} key={task.id}>
              <View style={[styles.Advert1, dynamicStyles.DivContainer]}>
                <View style={{paddingLeft: 20}}>
                  {tasks && task.platform && platformImages[task.platform]}
                </View>
                <View>
                  <View
                    style={{
                    ...
                    <Text
                      style={[
                        {color: '#fff', fontFamily: 'Manrope-ExtraBold'},
                        dynamicStyles.TextColor,
                        {width: '60%'},
                      ]}>
                      {tasks && task.platform && platformText[task.platform]}
                    </Text>
                    ...
                    <View>
                      ...
                      {tasks && task.status && taskStatus[task.status]}
                    </View>
                  </View>
                  <View
                    style={{
                    ...
                    <Text
                      ...
                      {tasks && task.platform && platformPrices[task.platform]}{' '}
                      per Advert Post
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <View style={{paddingVertical: 10, width: '50%'}}>
                      <Text
                        style={{color: '#fff', fontSize: 13, paddingBottom: 5}}>
                        Your Link / Caption - Click to Visit
                      </Text>
                      <Text
                        style={{
                          color: '#b1b1b1',
