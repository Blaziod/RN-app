                ...
                <View>
                  ...
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      ...
                      <Text style={styles.StepText}>
                        Open the Task Link above on your Instagran Mobile App or
                        browser
                      </Text>
                    </Text>
                  </View>
                  ...
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      Step 3:{' '}
                      <Text style={styles.StepText}>
                        Click on the Like or Follow button on the Instagram Page
                  ...
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      ...
                      <Text style={styles.StepText}>
                        ...
                        required to enter your Instagram Username or Name which
            ...
            <View style={{paddingVertical: 20}}>
              ...
              <View style={{paddingVertical: 20, alignItems: 'center'}}>
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('Earn3IG')}>
                  <Text
                    style={{
                      fontFamily: 'CamptonMedium',
                      justifyContent: 'center',
