        ...
        <View style={styles.AppContainer}>
          ...
          <View style={{paddingBottom: 20, paddingHorizontal: 20}}>
            ...
            <View
              ...
              <ImageBackground
                source={
                  GeneratedTasks?.performed_task?.task?.goal === 'Like'
                    ? require('../../assets/lsi.png')
                    : require('../../assets/fsi.png')
                }
                style={{
                  height: 'auto',
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  and followed the page. Your Trendit3 account will be suspended
                ...
                <View>
                  ...
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      ...
                      <Text style={styles.StepText}>
                        Open the Task Link above on your Mobile App or browser
                      </Text>
                    </Text>
                  </View>
                  ...
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      Step 2:{' '}
                      <Text style={styles.StepText}>
                        Follow or Like the account provided in the link
                      </Text>
                    </Text>
                  </View>
                  <View style={styles.StepView}>
                    <Text style={styles.Step}>
                      ...
                      <Text style={styles.StepText}>
                        ...
                        followed / Liked the page and upload the screenshot
                        under the Proof of Work Form below. You are also
                        required to enter your Username which you used to
                        perform the task
                      </Text>
                    </Text>
                  </View>
                ...
                <TouchableOpacity
                  ...
                  {fetching ? (
                    ...
                    <Text
                      ...
                      {GeneratedTasks?.performed_task?.task?.account_link}
                    </Text>
                  )}
                  <View>
                    <TouchableOpacity
              ...
              <View style={styles.Box2}>
                <View
                  ...
                  <Text style={styles.Box2Text}>
                    You must NOT DELETE THE ADVERT POST on the WhatsApp Status
            ...
            <View style={{paddingVertical: 20}}>
              <View
                ...
                <Text style={{color: '#fff', fontFamily: 'Manrope-Bold'}}>
                  Please enter the Username that performed this task
                </Text>
                <View style={{paddingVertical: 10}}>
                  <TextInput
                    style={{
