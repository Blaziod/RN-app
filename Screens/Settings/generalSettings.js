...
const GeneralSettings = () => {
  ...
  const openImagePicker = () => {
    ...
    launchImageLibrary(options, response => {
      ...
      if (response.didCancel) {
        ...
        const url = `${ApiLink.ENDPOINT_1}/profile-pic/edit`;
  ...
  const dynamicStyles = StyleSheet.create({
    AppContainer: {
      flex: 1,
      backgroundColor: theme === 'dark' ? '#171717' : '#FFFFFF', // Dynamic background color
      width: '100%',
    },
    DivContainer: {
      backgroundColor:
      ...
      <View style={{padding: 10}}>
        {isLoading ? (
          ...
          <>
            ...
            <Text style={[styles.Header, dynamicStyles.TextColor]}>
              Profile
            </Text>
            ...
            <View style={[styles.nameInputContainer]}>
              <TouchableOpacity style={styles.nameInput}>
                <TextInput
                  ...
                  style={[styles.textInput, dynamicStyles.TextColor]}
                />
              </TouchableOpacity>
